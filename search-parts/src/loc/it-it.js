    ...
    return {
        ...
        DataSources: {
            SharePointSearch: {
                ...
                SourceConfigurationGroupName: "Configurazione dell'origine di dati",
                QueryTextFieldLabel: "Testo della query",
                QueryTextFieldInfoMessage: "Utilizzare la scheda di configurazione della web part <strong>Connessioni disponibili</strong> per specificare un valore statico o un valore da un componente dinamico nella pagina come una casella di ricerca",
                QueryTemplateFieldLabel: "Template della query",
                QueryTemplatePlaceHolderText: "ex: Path:{Site}",
                QueryTemplateFieldDescription: "Il modello di query di ricerca. Puoi anche utilizzare {<tokens>} per creare una query dinamica.",
                ResultSourceIdLabel: "Origine di risultati Id / Scope|Name",
                ResultSourceIdDescription: "Selezionare un'origine incorporata, digitare un GUID di un'origine personalizzata o SCOPE e NAME dell'origine separati da | (es: SPSite|Notizie). Gli ambiti validi sono [SPSiteSubscription, SPSite, SPWeb]. Premere [Invio] per salvare.",
                InvalidResultSourceIdMessage: "Il valore fornito non è un GUID valido o è formattato come SCOPE|NAME",
                EnableQueryRulesLabel: "Abilita regole di query",
                RefinementFilters: "Filtri di raffinamento",
                RefinementFiltersDescription: "Filtri di raffinamento iniziali da applicare alla query. Questi non appariranno nei filtri selezionati. Per le espressioni stringa, utilizzare le virgolette doppie (\") invece delle virgolette singole (').",
                EnableLocalizationLabel: "Abilita la localizzazione",
                ...
                HitHighlightedPropertiesFieldDescription: "Fornisci l'elenco delle proprietà gestite da evidenziare (ad es. Department,UserName).",
                TermNotFound: "(Termine con ID '{0}' non trovato)",
                ApplyQueryTemplateBtnText: "Applica",
                EnableAudienceTargetingTglLabel: "Abilita l'assegnazione di gruppi di destinatari",
